...
from src.data.transforms import augment, paired_random_crop
from src.utils import FileClient, imfrombytes, img2tensor
from src.utils.flow_util import dequantize_flow
    ...
    def __getitem__(self, index):
        ...
        if self.flow_root is not None:
            img_results, img_flows = augment(
                img_lqs, self.opt["use_flip"], self.opt["use_rot"], img_flows
            )
        else:
