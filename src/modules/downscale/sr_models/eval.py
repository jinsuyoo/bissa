...
from metrics import calculate_psnr, calculate_ssim, tensor2img
...
parser.add_argument(
    "--model",
    default="checkpoints/edsr/model_epoch_30.pth",
    type=str,
    help="model path",
)
parser.add_argument("--dataset", default="P_GT", type=str, help="")
parser.add_argument("--gpus", default="3", type=str, help="gpu ids (default: 3)")
