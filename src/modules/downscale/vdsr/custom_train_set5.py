...
from custom_vdsr import CustomVDSR
import random
...
parser.add_argument(
    "--nEpochs", type=int, default=150, help="Number of epochs to train for"
)
...
parser.add_argument("--dataset", default="data/train.h5", type=str, help="dataset")
parser.add_argument("--color", default="ycbcr", type=str)
