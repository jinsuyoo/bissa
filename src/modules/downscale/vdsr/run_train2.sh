...
CUDA_VISIBLE_DEVICES=2 python custom_train.py --cuda --gpus 2 --nEpochs 1000 --lr 1e-4 --step 100 --lr-decay 0.5 --checkpoint "checkpoint/1000_100" | tee result_1000_100.md
